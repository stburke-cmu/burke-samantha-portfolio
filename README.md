...
<br>
After evaluating the feedback from my friends, I started creating my re-design in Tableau. First, I cleaned up the data file by deleting blank rows. Next, after connecting to the data, I created groupings in Tableau to combine the values into the appropriate categories (as noted on the bottom of the final graphic). Then, I altered the data types to show properly in Tableau. I started creating my single stacked bar chart then I decided I should try to create a stacked bar for each age group because I felt hesitant about grouping them into 1 age category in the first place. Displaying it this way brought different things about the data to my attention. First of all, the two younger groups have over 100%. This must mean that some respondents reported more than one allergy. Next, I realized that the oldest age group has over 10% more people without allergies compared to the other groups. I completely missed that with my wireframes. I took my friend's recommendation and tried different color schemes. I ultimately went with shades of green because it's a color that's often related to health and food. If you hover over specific categories, the tooltip shows the category name and percentage from each group. Also, the highlight tool can be used to isolate a specific allergy type across the age groups.
...
The feedback from my friends was valuable and guided me towards a better design. final grpahic. I am glad I did not combine the age groups because after seeing it displayed differently, I realized that comparing the age groups is an important part of the data. Overall, my goal was to show the data in a more organized and simplified way. I wanted readers to understand what was going on immediately without having to ask questions.
